...
Secondly, contents of IoT sensors are usually highly dynamically generated.
Third and most importantly, IoT sensors behaves differently may enter sleep mode periodically, whereas timely response is a critical performance of search. In this paper, we aim to accelerate IoT search by taking the third characteristic into considerations.
...
In this search system, we supposes every sensors supports IP protocol.
...
The sleep behavior of sensors and possible energy constraints makes it critical to choose crawling frequency and strategies for IoT crawlers.
