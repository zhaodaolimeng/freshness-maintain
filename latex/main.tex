...
EasiSC is periodically scheduled with the same strategy, only time period $[0, T]$ need to be discussed.
...
EasiSC compute for optimal or near optimal schedule strategy providing different models, given a fixed crawl time.
...
\subsection{Latency Expectation in an Arbitrary Period}
