...
Consider about the stability and standardization advantages, we use the pull-based architecture as the basic framework to study IoT crawl scheduling problem. The architecture of this pull-based IoT search system is illustrated by Fig.\ref{fig:architecture}. 
