...
Fig.\ref{fig:smarthome} is a clip of data stream from a temperature sensor located in a smart home environment, who acts as a sensor for air-conditioner control. 
...
In this section, we introduce the formulation of crawl schedule problem, along with the symbols used in the following paper. The follow assumptions are set to simplify sensors' working model.
