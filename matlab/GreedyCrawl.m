function [opt,arrange] = GreedyCrawl(lambdaList,timeTable,crawlLimitList,sumOfCrawl,discreteStep)
%% 
% A greedy method to generate a schedule strategy for sensors
% Should be faster than the dp one
